...
class TrayViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if Tray.currentTray.items.count == 0 {
            ...
            lbEmptyTray.text = "Your tray is empty. Please select a product."
            ...
            self.tbvProducts.isHidden = false
    ...
    @IBAction func addPayment(_ sender: Any) {
        ...
        if tbAddress.text == "" {
            // Showing alert that this feild is needed
...
extension TrayViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lbProductName.text = tray.product.name
        cell.lbSubTotal.text = "$\(tray.product.price! * Float(tray.qty))"
